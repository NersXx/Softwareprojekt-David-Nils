...
try:
    spirals_25 = SpiralData(np.load('datasets/spirals_25.npz'))
    spirals_50 = SpiralData(np.load('datasets/spirals_50.npz'))
    spirals_75 = SpiralData(np.load('datasets/spirals_75.npz'))
    spirals_100 = SpiralData(np.load('datasets/spirals_100.npz'))
except Exception as e:
    raise e
