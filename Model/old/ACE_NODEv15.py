...
def make_fns(model_static, optimizer):
    ...
    def loss_fn(params, model_static, x, y, last_idxs, attn):
        ...
        # 2. Standard Loss pro Beispiel berechnen
        loss = optax.sigmoid_binary_cross_entropy(preds, y)
        
        # 3. GEWICHTUNG EINFÜGEN (Der neue Teil)
        # Wie viel schlimmer ist es, eine 1 (Sepsis) zu verpassen?
        # pos_weight = 5.0 bedeutet: Ein Fehler bei einem Sepsis-Fall zählt 5x so viel.
        pos_weight = 16.0  
        
        # Erstelle einen Gewichts-Vektor:
        # Wo y == 1 ist (Sepsis), nutze pos_weight. Wo y == 0 ist, nutze 1.0.
