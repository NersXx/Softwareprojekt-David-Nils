...
def main() -> int:
    ...
    normalizer2.init(populations, 0)
    normalizer.init(time_steps, 0)
    time_steps_norm = normalizer.normalize(time_steps)
    populations_norm = normalizer2.normalize(populations)
    ...
    hl_predict = normalizer2.denormalize(model(t_pred, y0, initial_attention))
